...
public interface DevelopersProjectsDAO extends DAO<DevelopersProjects, DeveloperProjectKey> {
    String TABLE_NAME = "developers_projects";
    String INSERT = "INSERT INTO " + TABLE_NAME + "(project_id, developer_id) VALUES (?, ?)";
    String FIND_BY_ID = "SELECT * FROM " + TABLE_NAME + " WHERE project_id=? AND developer_id=?";
    String REMOVE_BY_ID = "DELETE FROM " + TABLE_NAME + " WHERE project_id=? AND developer_id=?";
