...
public interface DeveloperDAO extends DAO<Developer, Long> {
    ...
    String GET_LANGUAGE_DEVELOPERS = "SELECT * FROM " + TABLE_NAME + " d INNER JOIN " + TABLE_DEVELOPERS_SKILLS + " ds on d.id = ds.developer_id INNER JOIN " + TABLE_LANGUAGES + " l on ds.language_id = l.id WHERE l.name = ?";
